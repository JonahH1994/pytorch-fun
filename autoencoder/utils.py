...
def get_args():
    ...
    parser.add_argument('--encoder', type=str, default='', help='Name of file to resume training of Encoder')
    parser.add_argument('--decoder', type=str, default='', help='Name of file to resume training of Decoder')
