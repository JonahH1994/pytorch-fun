...
def get_args():
    ...
    parser.add_argument('--g_net', type=str, default='', help='Name of file to resume training of Generator')
    parser.add_argument('--d_net', type=str, default='', help='Name of file to resume training of Discriminator')
